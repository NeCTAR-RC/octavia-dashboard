...
(function() {
  ...
  function LoadBalancerDetailsController(patterns, gettext, $scope) {
    ...
    ctrl.azShorthand = function(availability_zone) {
      return availability_zone.name;
    };

    ctrl.setAz = function(option) {
      if (option) {
    ...
    */
    ...
    ctrl.buildAzOptions = function() {
      ctrl.azOptions = Object.keys($scope.model.availability_zones).filter(function(key) {
